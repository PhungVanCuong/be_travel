        ...
        $tours = [
            ...
            // ================= TOUR Trong nước =================
                ...
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2026/04/10/09/san-may-da-lat-ivv-450x265.gif',
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2026/06/15/14/lang-pa-vi-ha-ivv-1-450x265.png',
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                     'https://cdn2.ivivu.com/2025/04/15/10/cau-vang-ivv-450x265.gif',
                ]),
                'id_quoc_gia' => 1,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2025/06/09/17/ivivu-novaworld-phan-thiet-450x265.jpg'
                ]),
                'id_quoc_gia' => 1,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2023/03/02/11/ivivu-tour-xe-lua-450x265.gif'
                ]),
                'id_quoc_gia' => 1,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2023/03/15/16/ivivu-monastery-shangrila-02-450x265.gif',
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2022/03/28/16/ivivu-merlion-park-singapore-450x265.gif'
                ]),
                'id_quoc_gia' => 7,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2017/03/28/11/ivivu-angkor-wat-with-water-450x265.jpg'
                ]),
                'id_quoc_gia' => 3,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2022/07/13/17/ivivu-vinh-phang-nga-450x265.gif'
                ]),
                'id_quoc_gia' => 4,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'tinh_trang' => 1,
                'hinh_anh' => json_encode([
                    'https://cdn2.ivivu.com/2017/05/15/17/ivivu-senso-ji-temple-asakusa-kannon-450x265.jpg'
                ]),
                'id_quoc_gia' => 6,
                'created_at' => $now,
                'updated_at' => $now,
